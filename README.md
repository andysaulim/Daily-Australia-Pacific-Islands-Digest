...
<!-- STATS:START -->
**Last run:** 2026-08-25 &middot; 1,918 words &middot; sent

| Metric | Last 10 issues |
| --- | --- |
| Average length | 1,883 words |
| Pacific Wire items per issue | 7.0 |
| New Zealand items per issue | 3.7 |
| Issues where Pacific fell back to the stand-in | 0 of 3 |
| Issues where New Zealand fell back to the stand-in | 0 of 3 |
| Validation retries | 0 |
| Articles in the archive | 366 |
| Issues published | 1 |

_Updated 2026-08-25 03:06 PM ET._
<!-- STATS:END -->
