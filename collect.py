...
TIER1_FEEDS = {
    ...
    "The Australian":         _native("The Australian", "https://www.theaustralian.com.au/feed",
                              "site:theaustralian.com.au"),
    "AFR":                    _native("AFR", "https://www.afr.com/rss/feed",
                              "site:afr.com"),
    ...
    "Sky News Australia":     _native("Sky News Australia", "https://www.skynews.com.au/feed",
    ...
    "NZ Herald":              _native("NZ Herald", "https://www.nzherald.co.nz/arc/outboundfeeds/rss/section/nz/",
                              "site:nzherald.co.nz+politics+OR+defence+OR+foreign"),
    "Stuff":                  _native("Stuff", "https://www.stuff.co.nz/rss",
                              "site:stuff.co.nz+politics+OR+defence+OR+foreign"),
    "The Post (Wellington)":  _gnews("site:thepost.co.nz"),
    "1News":                  _native("1News", "https://www.1news.co.nz/feed/",
                              "site:1news.co.nz+politics+OR+pacific"),
    ...
    "Pacific Island Times":   _native("Pacific Island Times", "https://www.pacificislandtimes.com/blog-feed.xml",
                              "site:pacificislandtimes.com"),

    # ── Pacific Islands: national and regional press ────────────────────
    "PACNEWS":                _native("PACNEWS", "https://www.pina.com.fj/feed/",
                              "site:pina.com.fj+OR+%22PACNEWS%22"),
    "Benar News Pacific":     _native("Benar News Pacific", "https://www.benarnews.org/english/index.xml",
                              "site:benarnews.org+Pacific"),
    "Fiji Times":             "https://www.fijitimes.com.fj/feed/",
    "Samoa Observer":         _native("Samoa Observer", "https://www.samoaobserver.ws/feed",
                              "site:samoaobserver.ws"),
    "PNG Post-Courier":       "https://www.postcourier.com.pg/feed/",
    "The National (PNG)":     _native("The National (PNG)", "https://www.thenational.com.pg/feed/",
                              "site:thenational.com.pg"),
    "Solomon Star":           _native("Solomon Star", "https://www.solomonstarnews.com/feed/",
                              "site:solomonstarnews.com"),
    "Vanuatu Daily Post":     _native("Vanuatu Daily Post", "https://www.dailypost.vu/search/?f=rss",
                              "site:dailypost.vu"),
    "Cook Islands News":      _native("Cook Islands News", "https://www.cookislandsnews.com/feed/",
                              "site:cookislandsnews.com"),
    "Kaniva Tonga":           _native("Kaniva Tonga", "https://kanivatonga.nz/feed/",
                              "site:kanivatonga.nz"),
    "Marianas Variety":       _native("Marianas Variety", "https://www.mvariety.com/search/?f=rss",
                              "site:mvariety.com"),
    ...
    "Loop Pacific":           _native("Loop Pacific", "https://www.loopnews.com/feed",
                              "site:loopnews.com"),
    "FBC News (Fiji)":        _native("FBC News (Fiji)", "https://www.fbcnews.com.fj/feed/",
                              "site:fbcnews.com.fj"),
    "Fiji Sun":               _native("Fiji Sun", "https://fijisun.com.fj/feed/",
                              "site:fijisun.com.fj"),
    "Fijivillage":            _native("Fijivillage", "https://www.fijivillage.com/feed/",
                              "site:fijivillage.com"),
    "Pacific Islands Report": _gnews("site:pireport.org"),
    "Islands Business (wire)": _native("Islands Business (wire)", "https://islandsbusiness.com/feed/",
                              "site:islandsbusiness.com"),
