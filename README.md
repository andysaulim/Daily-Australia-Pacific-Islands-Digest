...
<!-- STATS:START -->
**Last run:** 2026-08-25 &middot; 1,516 words &middot; sent

| Metric | Last 10 issues |
| --- | --- |
| Average length | 1,865 words |
| Pacific Wire items per issue | 5.5 |
| New Zealand items per issue | 4.0 |
| Issues where Pacific fell back to the stand-in | 0 of 2 |
| Issues where New Zealand fell back to the stand-in | 0 of 2 |
| Validation retries | 0 |
| Articles in the archive | 324 |
| Issues published | 1 |

_Updated 2026-08-25 02:11 PM ET._
<!-- STATS:END -->
