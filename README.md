...
<!-- STATS:START -->
**Last run:** 2026-09-03 &middot; 1,752 words &middot; sent

| Metric | Last 10 issues |
| --- | --- |
| Average length | 1,722 words |
| Pacific Wire items per issue | 6.8 |
...
| Articles in the archive | 2,585 |
| Issues published | 8 |

_Updated 2026-09-03 06:12 AM ET._
<!-- STATS:END -->
