...
<!-- STATS:START -->
**Last run:** 2026-09-12 &middot; 1,596 words &middot; sent

| Metric | Last 10 issues |
| --- | --- |
| Average length | 1,830 words |
| Pacific Wire items per issue | 6.5 |
...
| Articles in the archive | 5,218 |
| Issues published | 16 |

_Updated 2026-09-12 06:14 AM ET._
<!-- STATS:END -->
