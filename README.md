...
<!-- STATS:START -->
**Last run:** 2026-09-04 &middot; 1,428 words &middot; sent

| Metric | Last 10 issues |
| --- | --- |
| Average length | 1,713 words |
| Pacific Wire items per issue | 6.9 |
...
| Articles in the archive | 2,921 |
| Issues published | 9 |

_Updated 2026-09-04 06:18 AM ET._
<!-- STATS:END -->
